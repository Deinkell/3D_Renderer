...
{
	float FloatR = MathLib::Clamp(R, 0.f, 1.f);
	float FloatG = MathLib::Clamp(G, 0.f, 1.f);
	float FloatB = MathLib::Clamp(B, 0.f, 1.f);
	float FloatA = MathLib::Clamp(A, 0.f, 1.f);
...
{
	return (MathLib::Abs(this->R - InColor.R) < InTolerance) &&
		(MathLib::Abs(this->G - InColor.G) < InTolerance) &&
		(MathLib::Abs(this->B - InColor.B) < InTolerance) &&
		(MathLib::Abs(this->A - InColor.A) < InTolerance);
}
